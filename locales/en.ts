export const en = {
  ...
  cms: {
    ...
    docs: {
      ...
      gettingStarted: {
        ...
        welcome:       'Hello. Thank you for your interest in Cartum CMS. This is a content and database manager designed to be used as a headless CMS. There are many CMS solutions out there, but most have a steep learning curve for both end users and developers. Cartum is built so that databases and REST APIs can be set up quickly and intuitively, under the idea of an infinite poker table. This project is designed to be used fast and easily in any type of project that needs a security layer, an API, and a content editing interface that is comfortable to use. I hope it helps you. Built by AzanoRivers.',
  ...
  settings: {
    ...
    webMigration: {
      ...
      phaseAnalyzing:       'Good hand, let me peek up your sleeve… Shuffling the cards…',
